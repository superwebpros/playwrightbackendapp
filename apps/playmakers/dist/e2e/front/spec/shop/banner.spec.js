...
function createTest() {
    (0, test_1.test)("dinamic banner", async ({ page }) => {
        ...
        await page.goto(frontUrl_1.default + "/collections/men", { waitUntil: "commit" });
        ...
        await page.goto(frontUrl_1.default + "/collections/women", { waitUntil: "commit" });
        ...
        await page.goto(frontUrl_1.default + "/collections/kids", { waitUntil: "commit" });
