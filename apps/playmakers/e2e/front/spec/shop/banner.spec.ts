...
export default function createTest() {
  test("dinamic banner", async ({ page }) => {
    ...
    await page.goto(url + "/collections/men", { waitUntil: "networkidle" });
    ...
    await page.goto(url + "/collections/women", { waitUntil: "networkidle" });
    ...
    await page.goto(url + "/collections/kids", { waitUntil: "networkidle" });
