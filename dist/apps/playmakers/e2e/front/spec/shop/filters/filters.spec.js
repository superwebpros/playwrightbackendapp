...
function createTest() {
    (0, test_1.test)("loaded", ({ page }) => __awaiter(this, void 0, void 0, function* () {
    ...
    (0, test_1.test)("initial filters configuration", ({ page }) => __awaiter(this, void 0, void 0, function* () {
        yield page.goto(frontUrl_1.default + "/collections/all");
        yield page.waitForLoadState();
        yield (0, test_1.expect)(page.getByRole("button", { name: "Gender" })).toBeVisible();
    ...
    (0, test_1.test)("more filters available when selecting a product type", ({ page }) => __awaiter(this, void 0, void 0, function* () {
        yield page.goto(frontUrl_1.default + "/collections/all");
        yield page.waitForLoadState();
        yield (0, test_1.expect)(page.getByRole("button", { name: "Gender" })).toBeVisible();
        yield (0, test_1.expect)(page.getByRole("button", { name: "Product Type" })).toBeVisible();
